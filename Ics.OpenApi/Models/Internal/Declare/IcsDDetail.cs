namespace Ics.OpenApi.Models.Internal.Declare
{
    ...
    internal record IcsDDetail
    {
        ...
        /// 成交数量
        /// </summary>
        public string DeclareUnitQty { get; init; }
        /// <summary>
        /// 成交计量单位
        /// </summary>
        ...
        /// <summary>
        /// 征免性质
        /// 1:照章征税;2:折半征税;3:全免;4:特案;5:征免性质;6:保证金;7:保函;8:折半补税;9:全额退税
        /// </summary>
        ...
        /// 法定第一数量
        /// </summary>
        public string LegalQty { get; init; }
        /// <summary>
        /// 法定第一计量单位
        /// </summary>
        ...
        /// 第二数量
        /// </summary>
        public string SecondQty { get; init; }
        /// <summary>
        /// 法定第二计量单位
        /// </summary>
