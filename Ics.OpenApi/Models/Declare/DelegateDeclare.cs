...
namespace Ics.OpenApi.Models.Declare
{
    ...
    public class DelegateDeclare
    {
        ...
        /// 1:费率 2:单价 3:总价
        /// </summary>
        public string Value1Type { get; init; }
        /// <summary>
        /// 保费
        /// </summary>
        ...
        /// 1:费率 2:单价 3:总价
        /// </summary>
        public string Value2Type { get; init; }
        /// <summary>
        /// 杂费
        /// </summary>
        ...
        /// 1:费率 2:单价 3:总价
        /// </summary>
        public string Value3Type { get; init; }
        /// <summary>
        /// 随附单证
        /// </summary>
        ...
        /// 0：否;1：是
        /// </summary>
        public int? IsRelationConfirm { get; init; }
        /// <summary>
        /// 价格影响确认
        /// 0：否;1：是
        /// </summary>
        public int? IsPriceConfirm { get; init; }
        /// <summary>
        /// 支付特许权使用费确认
        /// 0：否;1：是
        /// </summary>
        public int? IsPayConfirm { get; init; }
        /// <summary>
        /// 自报自缴
        /// 0：否;1：是
        /// </summary>
        public bool IsSelfPayment { get; init; }
        /// <summary>
        /// 公式定价确认
        /// </summary>
