...
{
    internal partial record IcsOutReplyWrapper<TReply>
    {
        public virtual IcsOutReplyStatus State { get; init; }
                ...
                case JsonValueKind.Array:
                    {
                        ...
                        try
                        {
                            return JsonSerializer.Deserialize<TReply>(subJson, IcsOutReplyJsonSerializerOptions.Default);
                        }
                        catch (Exception)
                        {
                        }
        ...
        [JsonIgnore]
        internal virtual string ErrorMessage => this.State switch
        {
            IcsOutReplyStatus.Succeed => null,
            _ => this.Message,
        };
    }
}
