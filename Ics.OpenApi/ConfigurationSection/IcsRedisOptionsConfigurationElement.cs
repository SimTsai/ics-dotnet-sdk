...
namespace Ics.OpenApi.ConfigurationSection
{
    ...
    /// Redis Token存储相关配置元素
    /// </summary>
    public partial class IcsRedisOptionsConfigurationElement : ConfigurationElement
    {
        ...
        public static implicit operator RedisCacheOptions(IcsRedisOptionsConfigurationElement configurationElement)
        {
