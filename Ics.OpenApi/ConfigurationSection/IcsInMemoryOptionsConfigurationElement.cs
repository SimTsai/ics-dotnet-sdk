...
namespace Ics.OpenApi.ConfigurationSection
{
    ...
    /// 进程内Token存储相关配置元素
    /// </summary>
    public partial class IcsInMemoryOptionsConfigurationElement : ConfigurationElement
    {
        ...
        public static implicit operator MemoryDistributedCacheOptions(IcsInMemoryOptionsConfigurationElement configurationElement)
        {
